...
2) Run tests and linting locally by doing `pnpm i && pnpm test:all`.
...
9) Once the pull request has been reviewed, those with write access to the branch will be able to merge your changes into the `Fumanchu` repository.
